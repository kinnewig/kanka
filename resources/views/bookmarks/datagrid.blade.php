        ...
        [
            ...
            'render' => function ($model) {
                if ($model->isDashboard()) {
                    ...
                    return '<i class="fa-solid fa-star"></i> ' . __('entities.entry');
                } elseif ($model->isList()) {
                    return '<i class="fa-solid fa-th-list"></i> ' . __('crud.fields.category');
                } elseif ($model->isRandom()) {
                    return '<i class="fa-solid fa-question"></i> ' . __('dashboards/widgets/random.name');
                }
                return '';
            },
            'disableSort' => true,
