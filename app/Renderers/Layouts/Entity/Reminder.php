...
class Reminder extends Layout
{
    ...
    public function columns(): array
    {
        $columns = [
            ...
            'recurring' => [
                'label' => '<i class="fa-solid fa-arrows-rotate" data-title="' . __('calendars.fields.is_recurring') . '" data-toggle="tooltip" aria-hidden="true"></i><span class="sr-only">' . __('calendars.fields.is_recurring') . '</span>',
                'render' => function (Model $reminder) {
